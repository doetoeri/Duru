    ...
    <main className="relative min-h-screen pt-20 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { name: '아침', items: SAMPLE_MEALS.breakfast, icon: '🌅', gradient: 'from-yellow-100 to-orange-100' },
            { name: '점심', items: SAMPLE_MEALS.lunch, icon: '☀️', gradient: 'from-green-100 to-emerald-100' },
            { name: '저녁', items: SAMPLE_MEALS.dinner, icon: '🌙', gradient: 'from-blue-100 to-cyan-100' },
          ].map((meal, idx) => (
            <div
              key={meal.name}
