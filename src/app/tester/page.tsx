      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="liquid-glass p-8 animate-fade-in-scale">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">✨ 테스트 가능한 기능</h2>
          ...
          <div className="liquid-glass p-8 animate-fade-in-scale" style={{ animationDelay: '0.2s' }}>
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">ℹ️ 프로젝트 정보</h2>
          ...
          <div className="liquid-glass p-8 border-l-4 border-red-400 bg-red-50 animate-fade-in-scale" style={{ animationDelay: '0.4s' }}>
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">⚠️ 위험 영역</h2>
            ...
            {!showConfirm ? (
              <button
                ...
                className="w-full bg-red-500 hover:bg-red-600 text-white font-medium py-3 rounded-xl transition-all duration-300 text-sm uppercase tracking-wide"
              >
                모든 데이터 삭제
              </button>
            ) : (
